...
class SentimentAnalysis:
    ...
    def DownloadData(self, keyword, tweets):
        ...
        # authenticating
        apiKey = '8CxlVODWvxiRSWAZ9xwj3mtnV'
        apiKeySecret = 'oAozSIFuzBnh6JiIP5k3890DqiRJWJ5mHiAwikkgse6WH9s5yP'
        accessToken = '1725178192321781760-vtzEaCHi7oQQC4WGeaWCOsmPI9bXH4'
        accessTokenSecret = 'PKVEPNJnTvJwdfs3SoNk3d4mHWa7jpIUBzq10tkNphFGS'
    ...
    def plotPieChart(self, positive, wpositive, spositive, negative, wnegative, snegative, neutral, keyword, tweets):
        ...
        plt.axis('equal')
        plt.tight_layout()
        strFile = r"C:\Users\anurup biswas\PycharmProjects\TW-Sentiment\static\images\plot.png"
